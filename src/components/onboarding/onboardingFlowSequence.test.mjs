...
test('onboarding steps retain coherent navigation', () => {
  ...
  assertTransition('overwhelmResponse', 'onContinue', 'supportSystem', 'continue');
  assertTransition('overwhelmResponse', 'onSkip', 'supportSystem', 'skip');
  assertTransition('supportSystem', 'onBack', 'overwhelmResponse', 'back');
