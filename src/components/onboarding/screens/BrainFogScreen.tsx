...
function descriptorFor(value: number): string {
  if (value <= 2) return 'Clear headed';
  if (value <= 4) return 'The odd off day';
  if (value <= 6) return 'Noticeably foggy';
  if (value <= 8) return 'Foggy most days';
  return 'Fogged in constantly';
}
