// The social proof and unlock list that step one used to carry. Held aside
// while the step is just Azo and the promise — render it back under
// <PaywallBenefitsStep /> to restore the longer version.
...
interface PaywallBenefitsDetailProps {
...
export function PaywallBenefitsDetail({
  features,
  name,
  hasTrial,
  trialDuration,
}: PaywallBenefitsDetailProps) {
...
export default PaywallBenefitsDetail;
