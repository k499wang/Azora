...
export default function BreatheActionSheet({
  ...
  // "Come from the middle": bubble emerges from the FAB position by
  // scaling up from a small size near its bottom-center while sliding
  // slightly upward. Combined with the tail pointing down at the FAB,
  // it reads as growing out of the FAB.
