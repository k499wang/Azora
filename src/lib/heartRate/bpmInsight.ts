...
export function buildBpmInsight(
  ...
  if (context === 'breathing-exercise') {
    ...
    return withShapeInsight(
      `Your heart rate stayed steady across the breathing graph. ${rangeDesc}. A stable line during a reset can be a useful sign that your body tolerated the rhythm smoothly.`,
    );
  }
