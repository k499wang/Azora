...
export const DAILY_REMINDER_DEFINITIONS = [
  {
    ...
    settings: {
      ...
      subtitle: 'A reminder for your primary guided exercise.',
    },
  ...
  },
  {
    ...
    content: {
      title: 'Your daily exercise is ready',
      body: 'Take a few minutes for today\'s breathing exercise.',
      channelId: NOTIFICATION_CHANNELS.dailyReminders,
    },
    defaultEnabled: false,
    onboardingEnabled: true,
    settings: {
      ...
      subtitle: 'A reminder for Azora’s daily exercise.',
    },
    onboardingTitle: 'Daily breathing exercise',
  },
  {
    id: 'checkIn',
